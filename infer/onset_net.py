...
class OnsetNet:
    def __init__(self,
        ...
        with tf.compat.v1.variable_scope('logit') as scope:
            logit_w = tf.compat.v1.get_variable('W', shape=[dnn_output_size, 1], initializer=tf.truncated_normal_initializer(stddev=1.0 / dnn_output_size, dtype=dtype), dtype=dtype)
